...
//        line3:egret.Bitmap;
        ...
        handRight:com.views.ui.scene.initScene.hand;//右手
        handLeft:com.views.ui.scene.initScene.hand;//左手

        luzhangRoundArr:any = [];

        bottomText:egret.TextField;

        teachTopBottom:egret.Shape;
...
//            this.addChild(this.bottomText);
        ...
        teachAni():void{
            ...
            var luzhang:com.views.ui.scene.gameScene.luzhang = this.luzhangFactory(2);
            ...
            var round:com.views.ui.scene.gameScene.round = this.roundFactory(3);
            this.addChild(round);

            egret.Tween.get(round,{loop:true}).wait(800).call(function(){
                egret.setTimeout(function(){
                    if(this.carRight==null)return;
            ...
            var luzhang1:com.views.ui.scene.gameScene.luzhang = this.luzhangFactory(0);
            ...
            var round1:com.views.ui.scene.gameScene.round = this.roundFactory(1);
